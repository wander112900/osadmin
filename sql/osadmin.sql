...
--
-- Host: localhost
-- Generation Time: Jul 23, 2013 at 07:53 AM
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='功能链接（菜单链接）' AUTO_INCREMENT=107 ;
...
(1, '首页', '/index.php', 1, 0, 1, 1, '后台首页', 0),
(2, '账号列表', '/admin/users.php', 1, 1, 1, 1, '账号列表', 0),
(3, '修改账号', '/admin/user_modify.php', 1, 0, 1, 0, '修改账号', 2),
(4, '新建账号', '/admin/user_add.php', 1, 0, 1, 1, '新建账号', 2),
(5, '个人信息', '/admin/profile.php', 1, 0, 1, 1, '个人信息', 0),
(6, '账号组成员', '/admin/group.php', 1, 0, 1, 0, '显示账号组详情及该组成员', 7),
(7, '账号组管理', '/admin/groups.php', 1, 1, 1, 1, '增加管理员', 0),
(8, '修改账号组', '/admin/group_modify.php', 1, 0, 1, 0, '修改账号组', 7),
(9, '新建账号组', '/admin/group_add.php', 1, 0, 1, 1, '新建账号组', 7),
(10, '权限管理', '/admin/group_role.php', 1, 1, 1, 1, '用户权限依赖于账号组的权限', 0),
(11, '菜单模块', '/admin/modules.php', 1, 1, 1, 1, '菜单里的模块', 0),
(12, '编辑菜单模块', '/admin/module_modify.php', 1, 0, 1, 0, '编辑模块', 11),
(13, '添加菜单模块', '/admin/module_add.php', 1, 0, 1, 1, '添加菜单模块', 11),
(14, '功能列表', '/admin/menus.php', 1, 1, 1, 1, '菜单功能及可访问的链接', 0),
(15, '增加功能', '/admin/menu_add.php', 1, 0, 1, 1, '增加功能', 14),
(16, '功能修改', '/admin/menu_modify.php', 1, 0, 1, 0, '修改功能', 14),
(17, '设置模板', '/admin/set.php', 1, 0, 1, 1, '设置模板', 0),
(18, '便签管理', '/admin/quicknotes.php', 1, 1, 1, 1, 'quick note', 0),
(19, '菜单链接列表', '/admin/module.php', 1, 0, 1, 0, '显示模块详情及该模块下的菜单', 11),
(20, '登入', '/login.php', 1, 0, 1, 1, '登入页面', 0),
(21, '操作记录', '/admin/syslog.php', 1, 1, 1, 1, '用户操作的历史行为', 0),
(22, '系统信息', '/admin/system.php', 1, 1, 1, 1, '显示系统相关信息', 0),
(23, 'ajax访问修改快捷菜单', '/ajax/shortcut.php', 1, 0, 1, 0, 'ajax请求', 0),
(24, '添加便签', '/admin/quicknote_add.php', 1, 0, 1, 1, '添加quicknote的内容', 18),
(25, '修改便签', '/admin/quicknote_modify.php', 1, 0, 1, 0, '修改quicknote的内容', 18),
(26, '系统设置', '/admin/setting.php', 1, 0, 1, 0, '系统设置', 0),
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='菜单模块' AUTO_INCREMENT=4 ;
...
(1, '控制面板', '/index.php', 0, '配置OSAdmin的相关功能', 'icon-th', 1),
(2, '样例模块', '/index.php', 1, '样例模块', 'icon-leaf', 1);
...
(1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 'SomewhereYu', '13800138001', 'admin@osadmin.org', '初始的超级管理员!', 1374553519, 1, '127.0.0.1', 1, 'schoolpainting', '2,7,10,11,13,14,18,21,24', 0),
